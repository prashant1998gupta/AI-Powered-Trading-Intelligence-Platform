...
const riskAlerts = mockInsights.filter((i) => i.category === "risk" || i.type === "danger");
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="glass-card p-5">
            ...
            <p className="text-sm text-ag-text-muted mt-1">
              Current equity: {formatCurrency(capitalDeployed + mockAccountSummary.totalPnl)}
            </p>
            <div className="mt-3 flex items-center gap-2">
              <span className={cn(
                "text-sm font-bold number-display",
                mockAccountSummary.totalPnl >= 0 ? "text-ag-profit" : "text-ag-loss"
              )}>
                {mockAccountSummary.totalPnl >= 0 ? "+" : ""}{mockAccountSummary.totalPnlPercent}%
              </span>
          ...
          <div className="glass-card p-5">
            ...
            <div className="mt-3 w-full bg-ag-bg-elevated rounded-full h-2">
              <div className="h-2 rounded-full bg-ag-warning transition-all" style={{ width: "64%" }} />
            </div>
            <p className="text-[10px] text-ag-text-muted mt-1">
              ₹1,800 remaining
            </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-3 flex flex-col justify-center">
              {instrumentData.map((inst, i) => {
                ...
                const pct = Math.round((inst.trades / totalTrades) * 100);
                return (
