...
import { mockChatHistory, quickPrompts, type ChatMessage } from "@/data/mockInsights";
import {
  Send,
  Bot,
  User,
...
export default function AICoachClient({ insights }: AICoachClientProps) {
        ...
        <div className="space-y-4 overflow-y-auto max-h-full">
          <div className="glass-card p-5">
            ...
            <div className="space-y-3">
              {insights.length === 0 && (
                <p className="text-sm text-ag-text-muted text-center py-4">No active insights at the moment.</p>
              )}
...
// Mock AI response generator (We will update this in Option C)
