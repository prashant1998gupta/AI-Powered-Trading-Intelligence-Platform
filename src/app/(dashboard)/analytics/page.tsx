...
const revengeCount = detectRevengeTrading();
const overtradingDays = detectOvertrading();
const hourlyData = getPerformanceByHour();
const heatmapData = getTradingHeatmap();

// Get position size distribution
function getPositionSizeDistribution() {
  const sizes = mockTrades.map((t) => t.quantity * t.entryPrice);
...
const positionDist = getPositionSizeDistribution();
...
const patterns = [
  {
    ...
    impact: "-₹18,450 estimated impact",
